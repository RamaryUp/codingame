...
# URL : https://www.codingame.com/training/medium/skynet-revolution-episode-1
...
# n1 and n2 defines a link between these nodes
    n1, n2 = sorted(int(j) for j in input().split())
    links.append((n1, n2))
...
while True:
    ...
    for ei in exits:
        ...
        if(x, y) in links:
            ...
            break
    if not found:
        print("{} {}".format(links[0][0], links[0][1]))
        del(links[0])
